...
const services = {
   "Remote Legal Consultation/استشارة قانونية عن بعد": { url: "service-index/cons.html", icon: "bx bx-right-arrow-alt" },
   "استشارة قانونية عن بعد ": { url: "service-index/cons-remot.html", icon: "bx bx-right-arrow-alt" },
